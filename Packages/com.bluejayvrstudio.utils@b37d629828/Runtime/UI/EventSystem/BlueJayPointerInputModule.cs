...
namespace bluejayvrstudio
{
    ...
    /// </summary>
    public abstract class BlueJayPointerInputModule : BaseInputModule
    {
        GraphicRaycaster graphicRaycaster;
        public GameObject cursor;
        public Vector2 CursorPress;
        public Vector2 CursorCurrent;
        ...
        protected virtual void ProcessDrag(PointerEventData pointerEvent)
        {
            ...
            //     return;
            // Debug.Log(ShouldStartDrag(CursorPress, CursorCurrent, eventSystem.pixelDragThreshold, pointerEvent.useDragThreshold));

            if (!pointerEvent.dragging
                && ShouldStartDrag(CursorPress, CursorCurrent, eventSystem.pixelDragThreshold, pointerEvent.useDragThreshold)) //ShouldStartDrag(pointerEvent.pressPosition, pointerEvent.position, eventSystem.pixelDragThreshold, pointerEvent.useDragThreshold))
            {
        ...
        private List<RaycastResult> CreateForwardRaycast(PointerEventData pointerData)
        {
