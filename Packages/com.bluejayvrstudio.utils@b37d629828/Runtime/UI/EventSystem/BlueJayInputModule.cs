...
{
    [AddComponentMenu("Event/BlueJay Input Module")]
    /// <summary>
    ...
    /// </remarks>
    public class BlueJayInputModule : BlueJayPointerInputModule
    {
        ...
        {
            // Debug.Log($"Pressed Pos: {CursorPress}, Current Pos: {CursorCurrent}");
        ...
        protected void ProcessMousePress(MouseButtonEventData data)
        {
            ...
            if (data.PressedThisFrame())
            {
                ...
                pointerEvent.pressPosition = pointerEvent.position;
                pointerEvent.pointerPressRaycast = pointerEvent.pointerCurrentRaycast;
                CursorPress = (Vector2) cursor.transform.localPosition;
                CursorCurrent = (Vector2) cursor.transform.localPosition;
        ...
        protected override void ProcessDrag(PointerEventData pointerEvent)
        {
            ...
            // Debug.Log(pointerEvent.dragging);
